...
const redirectsFound = (GATE.match(/\s*location\.href="roster\/";\r?\n/g) || []).length;
...
${up(CSS)}
  ...
  .rp-main{padding:34px 0 60px}
  .rp-back{display:inline-flex;align-items:center;gap:7px;font-size:11.5px;font-weight:800;
    letter-spacing:.12em;text-transform:uppercase;color:var(--tx-m);margin-bottom:18px}
  .rp-back:hover{color:var(--tx)}
...
<main class="wrap rp-main">
  <a class="rp-back" href="../index.html">&larr; <span data-i18n="rp_back"></span></a>
